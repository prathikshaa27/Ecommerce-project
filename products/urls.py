...
from .views import list_products, manage_cart,list_categories, list_products_by_categories
...
urlpatterns =[
    ...
    path('api/categories/<int:category_id>/',list_products_by_categories, name='category_list')
]